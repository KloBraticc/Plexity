...
namespace Plexity.Integrations
{
    public class Cleaner
    {
        ...
        public static void DoCleaning()
        {
            ...
            App.Logger.WriteLine(LogLevel.Info, LOG_IDENT, "Cleaner has started");
            ...
            foreach (var directory in Directories)
            {
                ...
                {
                    App.Logger.WriteLine(LogLevel.Info, LOG_IDENT, $"Skipping {Type}");
                    continue;
                }
                ...
                try
                {
                    ...
                    App.Logger.WriteLine(LogLevel.Info, LOG_IDENT, $"Running cleaner in {directory}, {Files.Length} files found");
                    ...
                    foreach (string file in Files)
                    {
                        ...
                        {
                            App.Logger.WriteLine(LogLevel.Info, LOG_IDENT, $"Unable to delete {file}");
                ...
                {
                    App.Logger.WriteLine(LogLevel.Info, LOG_IDENT, $"Failed to clean up {Folder}");
                    App.Logger.WriteException(LOG_IDENT, ex);
                }
            }

            App.Logger.WriteLine(LogLevel.Info, LOG_IDENT, "Cleaner finished");
        }
