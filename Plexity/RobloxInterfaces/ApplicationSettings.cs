    ...
    public class ApplicationSettings
    {
        ...
        private async Task FetchAsync()
        {
            ...
            try
            {
                ...
                App.Logger.WriteLine(LogLevel.Info, logIndent, "Fetching fast flags");
                ...
                {
                    App.Logger.WriteLine(LogLevel.Info, logIndent, "Failed to contact clientsettingscdn! Falling back to clientsettings...");
