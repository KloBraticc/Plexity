...
namespace Plexity
{
    ...
    {
        private FastZipEvents _fastZipEvents;

        public FastZip(FastZipEvents fastZipEvents)
        {
            this._fastZipEvents = fastZipEvents;
        }

        internal void ExtractZip(object downloadPath, string packageFolder, string? fileFilter)
        {
