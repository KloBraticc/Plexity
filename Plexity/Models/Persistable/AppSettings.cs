...
namespace Plexity.Models.Persistable
{
    ...
    public class AppSettings
    {
        ...
        public bool UseClientAppSettings { get; set; } = true;
        ...
        public bool IsFirstTime2 { get; set; } = true;
        ...
        public string ThemeModes { get; set; } = "Dark";

        public string PaneDisplayMode { get; set; } = "LeftFluent";

        public string RobloxLaunchVersion { get; set; } = "Normal";

        public bool ForceRobloxReinstallation { get; set; } = false;

        public bool DebugLog { get; set; } = false;

        public bool KeepPlexityOpen { get; set; } = false;

        public string RobloxPriority { get; set; } = "Normal";

        public int RobloxStartWaitTime { get; set; } = 1000;
